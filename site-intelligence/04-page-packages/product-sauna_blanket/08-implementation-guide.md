...
Secondary modality route for sauna_blanket.
...
1. Remove from sitemap and set noindex until the route is truthful.
2. Fix the data/render mismatch.
3. Decide whether the modality deserves a real public route at all.

## Content and messaging tasks
- Remove from sitemap and set noindex until the route is truthful.
- Fix the data/render mismatch.
- Decide whether the modality deserves a real public route at all.
