...
Introduce Hylono and route visitors into the canonical graph.
...
1. Rewrite the hero so it states what Hylono does, for whom, and why the access model matters.
2. Move verification/support/rental proof directly below the first CTA cluster.
3. Reduce critical-path motion and keep the main hub links obvious without scrolling.

## Content and messaging tasks
- Rewrite the hero so it states what Hylono does, for whom, and why the access model matters.
- Move verification/support/rental proof directly below the first CTA cluster.
- Reduce critical-path motion and keep the main hub links obvious without scrolling.
