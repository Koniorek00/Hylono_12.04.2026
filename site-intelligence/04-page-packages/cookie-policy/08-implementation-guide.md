...
1. Preserve the template and factual structure.
2. Remove duplicate cookie-consent mounting.
3. Validate published operational facts against the real business process.

## Content and messaging tasks
- Preserve the template and factual structure.
- Remove duplicate cookie-consent mounting.
- Validate published operational facts against the real business process.
