...
1. Strengthen headings, empty states, and support cues.
2. Verify auth, loading, and error behavior.
3. Prioritize keyboard flow and clear task completion.

## Content and messaging tasks
- Strengthen headings, empty states, and support cues.
- Verify auth, loading, and error behavior.
- Prioritize keyboard flow and clear task completion.
