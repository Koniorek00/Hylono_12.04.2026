...
Commercial hub for product-family discovery and rental / buy decisions.
...
- lib/product-routes.ts
- constants.ts

## Exact execution sequence
1. Sharpen the hero, first answer block, and CTA hierarchy.
2. Improve visible ownership/limitations/trust framing where relevant.
3. Reduce dependence on large client shells for first-view understanding.

## Content and messaging tasks
- Sharpen the hero, first answer block, and CTA hierarchy.
- Improve visible ownership/limitations/trust framing where relevant.
- Reduce dependence on large client shells for first-view understanding.
