# /conditions/comfort Implementation Prompt

You are implementing the Hylono route package for `/conditions/comfort`.

Page goal: Condition detail page for comfort.
