# /protocols/vitality-dual-stack Implementation Prompt

You are implementing the Hylono route package for `/protocols/vitality-dual-stack`.

Page goal: Protocol detail page for vitality-dual-stack.
