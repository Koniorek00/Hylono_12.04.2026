# /product/hydrogen/[model] Implementation Prompt

You are implementing the Hylono route package for `/product/hydrogen/[model]`.

Page goal: Alias route to hydrogen premium PDPs.
