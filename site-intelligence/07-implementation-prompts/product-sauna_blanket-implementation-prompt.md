# /product/sauna_blanket Implementation Prompt

You are implementing the Hylono route package for `/product/sauna_blanket`.

Page goal: Secondary modality route for sauna_blanket.
