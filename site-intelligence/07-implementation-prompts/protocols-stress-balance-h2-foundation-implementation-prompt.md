# /protocols/stress-balance-h2-foundation Implementation Prompt

You are implementing the Hylono route package for `/protocols/stress-balance-h2-foundation`.

Page goal: Protocol detail page for stress-balance-h2-foundation.
