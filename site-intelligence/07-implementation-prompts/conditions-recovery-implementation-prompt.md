# /conditions/recovery Implementation Prompt

You are implementing the Hylono route package for `/conditions/recovery`.

Page goal: Condition detail page for recovery.
