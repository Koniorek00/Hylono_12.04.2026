    ...
    <div className="bg-white rounded-xl p-6 border border-slate-100 shadow-sm">
        ...
        {helpful !== undefined && (
            <button className="flex items-center gap-2 text-xs text-slate-400 hover:text-slate-600 transition-colors">
                <ThumbsUp size={14} /> {helpful} found this helpful
            </button>
        )}
    </div>
);
...
export const TestimonialCarousel: React.FC = () => {
    ...
    const testimonials = [
        { name: 'Dr. Elena Kowalski', role: 'Sports Medicine Director', company: 'Warsaw Athletic Center', text: 'Hylono transformed our recovery protocols. Our athletes are performing at unprecedented levels with 40% faster recovery times.', image: 'from-cyan-500 to-blue-500' },
        { name: 'Prof. Michael Chen', role: 'Integrative Medicine', company: 'BioHarmony Clinic', text: 'The quality and precision of Hylono equipment is unmatched. Finally, technology that meets medical-grade standards at accessible prices.', image: 'from-purple-500 to-pink-500' },
