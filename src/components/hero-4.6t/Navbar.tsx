...
export const Navbar: React.FC = () => {
    ...
    const { isOpen: multitoolOpen, toggle: toggleMultitool } = useMultitoolStore();
        ...
        >
            <div className="max-w-[1200px] w-full mx-auto px-6 flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                    <Link href="#learn" className="hidden md:block text-[14px] font-medium text-[#6B6B60] hover:text-[#0A6E6E] transition-colors relative group">
                        Learn
                    ...
                    <motion.button
                        ...
                        className={`
                            ...
                            ${multitoolOpen 
                                ...
                                : 'bg-[#F0F0EB] text-[#6B6B60] hover:text-[#0A6E6E] hover:bg-[#E0DED6]'
                            }
                        `}
