...
export const conditionGoals: ConditionGoalPage[] = [
  {
    ...
    evidenceIds: ['ev-hbot-001', 'ev-hbot-002', 'ev-h2-001'],
    faq: [
      {
    ...
    stacks: [
      {
        ...
        link: '/wellness-planner?goal=sleep&tier=starter',
      },
      {
        title: 'Optimal',
        devices: ['PEMF', 'H2'],
        ...
        link: '/wellness-planner?goal=sleep&tier=optimal',
        highlighted: true,
      },
      {
        title: 'Pro',
        ...
        link: '/wellness-planner?goal=sleep&tier=pro',
      },
    ],
    evidenceIds: ['ev-hbot-003', 'ev-h2-002'],
    faq: [
      {
    ...
    stacks: [
      {
        ...
        link: '/wellness-planner?goal=stress&tier=starter',
      },
      {
        title: 'Optimal',
        devices: ['H2', 'PEMF'],
        rentalPrice: 'from €308/mo',
        purchasePrice: 'from €4,790',
        link: '/wellness-planner?goal=stress&tier=optimal',
        highlighted: true,
      },
      {
        title: 'Pro',
  ...
  },
  {
    ...
    stacks: [
      {
        ...
        link: '/wellness-planner?goal=comfort&tier=starter',
      },
      {
        title: 'Optimal',
        devices: ['RLT', 'H2'],
        ...
        link: '/wellness-planner?goal=comfort&tier=optimal',
        highlighted: true,
      },
      {
        title: 'Pro',
    ...
    evidenceIds: ['ev-hbot-002', 'ev-h2-001'],
    faq: [
      {
  ...
  },
  {
    ...
    stacks: [
      {
        ...
        rentalPrice: 'from €159/mo',
        purchasePrice: 'from €2,400',
        link: '/wellness-planner?goal=vitality&tier=starter',
      },
      {
        title: 'Optimal',
        devices: ['HBOT', 'H2'],
    ...
    evidenceIds: ['ev-hbot-001', 'ev-h2-001', 'ev-h2-003'],
    faq: [
      {
