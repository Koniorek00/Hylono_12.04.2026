# Metabase — Blueprints and Assets

    ## Phase D — Indexed deployment and implementation assets
    | Asset | Kind | Status | License / usage | Version | Notes |
|---|---|---|---|---|---|
| Official docs | official docs | indexed-only | AGPL-3.0 | v0.59.5 | Primary install/admin docs. |
| Official repo | source code | indexed-only | AGPL-3.0 | v0.59.5 | Primary code source. |
| Docker image docs | deployment docs | indexed-only | docs | current | Useful deployment path. |
