...
- Start with a small curated set of operational dashboards over trusted Postgres sources.
...
- Read the source-of-truth map before connecting Metabase to everything.
...
### Never-assume list
- Never grant Metabase unrestricted production DB access by default.
