...
- Stick with current site architecture unless editorial requirements clearly demand a CMS.
...
- Read the current Hylono content architecture before recommending Strapi.
...
### Never-assume list
- Never introduce a CMS just because a site is content-heavy; validate real workflow pain first.
