...
- **Business usefulness:** Could front content for Next.js and possibly docs/help content, but is not automatically needed.
- **Implementation complexity:** **Medium**
- **Maintenance burden:** **Medium**
- **Risk level:** **Medium**
- **Deployment priority:** **ONLY IF CONTENT OPS OUTGROW CURRENT APPROACH**
...
- Compare current content workflows against real CMS needs before adopting.
...
- Mostly editorial data unless user-generated content is added.
