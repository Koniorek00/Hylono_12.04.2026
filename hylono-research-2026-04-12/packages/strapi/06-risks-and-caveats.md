# Strapi — Risks and Caveats

## Phase E/F — Operational and compliance caveats
- **Primary risk:** Moderate duplication risk.
- **Security posture note:** CMS admin is a privileged surface; media uploads and content API exposure need care.
- **Maintenance hotspot:** Content model migrations, plugin updates, and admin security matter.
- **Hidden complexity:** Adding CMS complexity when content volume/editorial workflow does not justify it.
- **EU / GDPR / health-data relevance:** Mostly editorial data unless user-generated content is added.
