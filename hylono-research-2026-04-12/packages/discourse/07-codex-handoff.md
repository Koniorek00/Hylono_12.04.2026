...
- Use Discourse only if Hylono commits to community moderation and discussion as a strategic surface.
...
- Read the overlap map with Apache Answer, BookStack, and Docusaurus first.
...
### Never-assume list
- Never assume a forum will self-sustain without moderation and editorial effort.
