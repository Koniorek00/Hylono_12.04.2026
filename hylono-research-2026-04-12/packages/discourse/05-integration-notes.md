...
- **Business usefulness:** Can integrate with ZITADEL/OIDC, site identity links, Novu/Listmonk announcements, and knowledge workflows.
- **Implementation complexity:** **Medium to High**
- **Maintenance burden:** **High**
- **Risk level:** **Medium**
- **Deployment priority:** **CHOOSE ONLY IF COMMUNITY IS STRATEGIC**
...
- Confirm whether Hylono wants ongoing community discussion or just structured Q&A/help.
...
- User accounts and posts are personal data. Retention/moderation/export processes matter.
