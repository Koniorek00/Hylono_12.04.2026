...
- Implement as a focused front-end consent component if existing consent UX is weak.
...
- Read the current site analytics/consent implementation before changing anything.
...
### Never-assume list
- Never treat a cookie banner as complete compliance coverage.
