...
- Use n8n as the integration/orchestration layer around the core app, not as a substitute for domain logic that belongs in the app codebase.
...
- Read current Next.js API routes, webhook/event map, and n8n production docs before building flows.
...
### Never-assume list
- Never assume local-test webhooks or tunnel behavior represent production. Never assume execution data can be retained indefinitely.
