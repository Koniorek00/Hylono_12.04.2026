...
- Do not implement without explicit stakeholder decision that PHI/clinical-grade workflows are in scope.
...
- Read the health-data strategy decision and compliance notes before considering Medplum.
...
### Never-assume list
- Never treat health-adjacent wellness operations as equivalent to a healthcare software mandate.
