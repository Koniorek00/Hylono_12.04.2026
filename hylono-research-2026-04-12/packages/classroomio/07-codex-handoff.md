...
- Do not implement unless Hylono commits to a real classroom product and the project is revalidated.
...
- Read the maturity and overlap notes first.
...
### Never-assume list
- Never trust stale or secondary version data for ClassroomIO.
