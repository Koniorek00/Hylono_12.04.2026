...
- Keep PostHog focused on product analytics and feature flags; avoid self-hosting unless strong data-control reasons justify the heavier platform footprint.
...
- Read the existing PostHog integration in the Hylono site before proposing any changes.
...
### Never-assume list
- Never assume self-host PostHog is an easy drop-in just because the code is open.
