...
- Default to the existing Next.js site unless there is a specific reason for a separate docs platform.
...
- Read the current content architecture before proposing Docusaurus.
...
### Never-assume list
- Never assume another React docs framework is automatically a win just because it is popular.
