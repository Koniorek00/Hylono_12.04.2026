...
- Defer until there is enough infrastructure and ownership to justify it.
...
- Read the security-operations maturity notes before recommending Wazuh.
...
### Never-assume list
- Never deploy SIEM/EDR-style platforms without people/process to run them.
