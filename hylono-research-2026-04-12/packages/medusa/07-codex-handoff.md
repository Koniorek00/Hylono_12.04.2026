...
- Prototype Medusa as a separate commerce service on a subdomain or internal environment. Prove catalog/order benefits before changing public-site architecture.
...
- Read the current site checkout/rental architecture and Medusa’s official Next.js starter before proposing a replatform.
...
### Never-assume list
- Never assume Medusa should own the whole frontend. Never assume standard ecommerce models cover Hylono rental/protocol workflows without extension work.
