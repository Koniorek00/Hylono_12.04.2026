...
- **Business usefulness:** Can integrate with Next.js site chat widget, Twenty CRM, n8n, Novu, and support analytics.
- **Implementation complexity:** **Medium**
- **Maintenance burden:** **Medium**
- **Risk level:** **Medium**
- **Deployment priority:** **LATER / GOOD SUPPORT PLATFORM**
...
- Decide whether support chat/inbox is strategic now or later.
...
- Support transcripts are personal data; retention/access/export matter.
