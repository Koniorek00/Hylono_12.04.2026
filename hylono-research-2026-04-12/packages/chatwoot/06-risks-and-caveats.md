# Chatwoot — Risks and Caveats

## Phase E/F — Operational and compliance caveats
- **Primary risk:** Moderate, but useful when customer support scales.
- **Security posture note:** Support conversations can contain PII and sensitive service details. Access control and retention matter.
- **Maintenance hotspot:** Agent workflow, channel integrations, and response/SLA ownership matter.
- **Hidden complexity:** Adding support tooling before support process is defined, or duplicating CRM/support ownership badly.
- **EU / GDPR / health-data relevance:** Support transcripts are personal data; retention/access/export matter.
