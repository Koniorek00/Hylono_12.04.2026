...
- Defer until there is enough behavioral data to justify it.
...
- Read data-maturity notes before considering Gorse.
...
### Never-assume list
- Never add ML-style personalization before proving simpler ranking cannot solve the need.
