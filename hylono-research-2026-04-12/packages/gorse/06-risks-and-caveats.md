# Gorse — Risks and Caveats

## Phase E/F — Operational and compliance caveats
- **Primary risk:** Moderate low-priority complexity.
- **Security posture note:** Main risk is data quality and recommendation misuse rather than infrastructure exposure.
- **Maintenance hotspot:** Data freshness, recommendation quality, and model tuning matter.
- **Hidden complexity:** Trying to personalize too early with weak data.
- **EU / GDPR / health-data relevance:** Behavioral data for recommendations requires transparency and minimization.
