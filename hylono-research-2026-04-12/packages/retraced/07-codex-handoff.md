...
- Use only if centralized audit logging is a confirmed requirement and existing app logs are insufficient.
...
- Read current audit requirements and verify project activity before proceeding.
...
### Never-assume list
- Never assume central audit logging is valuable if critical actions are not instrumented consistently.
