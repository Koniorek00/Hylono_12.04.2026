...
- Do not implement unless a real dispatch/fleet use case is confirmed.
...
- Read the Hylono operating model before touching Fleetbase.
...
### Never-assume list
- Never assume shipping or rental logistics automatically justify a fleet platform.
