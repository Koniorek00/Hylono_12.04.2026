...
- Use Formbricks for bounded feedback/survey workflows once customer research becomes structured.
...
- Read current feedback-collection methods and data-sensitivity rules first.
...
### Never-assume list
- Never ask for health-sensitive data just because a survey tool makes it easy.
