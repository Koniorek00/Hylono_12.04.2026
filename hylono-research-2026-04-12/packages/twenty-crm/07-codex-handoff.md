...
- Use Twenty as CRM of record for leads/accounts/opportunities; keep the Next.js site focused on capture, identity, commerce, and operational workflows. Synchronize through n8n or explicit server actions/webhooks.
...
- Read the official developer docs, API/webhook references, and current Hylono API routes before mapping lead and booking events.
...
### Never-assume list
- Never assume site tables and CRM objects have identical schema or lifecycle ownership. Never assume webhook payloads or API scopes without testing against the running version.
