# Twenty CRM — Integration Notes

## Phase E — Hylono fit analysis
- **Business usefulness:** Strong touchpoints with Next.js contact/booking/rental flows, n8n for orchestration, Novu for notifications, Stripe/rental operations, and PostHog or Metabase for lifecycle analytics.
- **Implementation complexity:** **Medium**
- **Maintenance burden:** **Medium**
- **Risk level:** **Medium**
- **Deployment priority:** **KEEP AND DEEPEN INTEGRATION EARLY**
...
- Define system-of-record boundaries: what lives in Twenty versus the Hylono core app database, and whether sales workflow customization should be done in CRM or automation layer.
...
- Contains identifiable customer/prospect data. EU hosting, consent basis, retention, export/delete workflows, and access controls are mandatory.
