...
- Prefer BookStack unless Outline’s collaborative UX is explicitly required.
...
- Read the docs-platform overlap map before choosing Outline.
...
### Never-assume list
- Never ignore source-available license terms when planning reuse or bundling.
