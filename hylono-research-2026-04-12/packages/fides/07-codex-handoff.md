...
- Keep Fides on the roadmap for later governance maturity, not as an immediate deployment item.
...
- Read actual privacy-program requirements before suggesting Fides implementation.
...
### Never-assume list
- Never assume privacy software is useful without process and ownership behind it.
