...
- Do not implement unless the business model changes toward patient-record handling.
...
- Read the business-fit notes; this is likely out of scope.
...
### Never-assume list
- Never adopt a health-record system just because the company is health-adjacent.
