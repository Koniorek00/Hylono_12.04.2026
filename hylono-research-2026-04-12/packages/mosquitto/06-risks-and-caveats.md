# Mosquitto — Risks and Caveats

## Phase E/F — Operational and compliance caveats
- **Primary risk:** Low infrastructure risk, high unnecessary-complexity risk if premature.
- **Security posture note:** Broker exposure is risky. Use TLS, ACLs, and network isolation.
- **Maintenance hotspot:** Client ACLs, connection monitoring, TLS, and broker uptime matter.
- **Hidden complexity:** Introducing MQTT infrastructure without an actual MQTT use case.
- **EU / GDPR / health-data relevance:** Depends on device payloads.
