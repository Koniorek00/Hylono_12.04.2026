...
- Add only when a real MQTT topology is defined.
...
- Read the IoT notes before considering Mosquitto.
...
### Never-assume list
- Never deploy brokers without clear client and ACL design.
