...
- Use it as the first visibility layer while Prometheus/Grafana mature underneath.
...
- Read the deployment docs and decide which endpoints should be monitored privately versus exposed on a status page.
...
### Never-assume list
- Never assume Uptime Kuma replaces metrics, traces, logs, or security monitoring.
