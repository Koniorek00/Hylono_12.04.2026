...
- Prototype Leihs as a back-office rental engine first. Expose only the customer-facing pieces needed through Hylono’s Next.js site or APIs.
...
- Read the main repo and leihs-instance deployment blueprint before proposing rental-system design.
...
### Never-assume list
- Never assume Leihs customer UX is ready for direct exposure without adaptation. Never assume its institutional workflow defaults match commercial rental needs.
