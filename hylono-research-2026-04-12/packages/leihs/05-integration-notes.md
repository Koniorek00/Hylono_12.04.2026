# Leihs — Integration Notes

## Phase E — Hylono fit analysis
- **Business usefulness:** Strong candidate to back rental/access programs, equipment availability, reservation states, and handoff/return operations. Could integrate with Next.js booking flows, CRM, notifications, and billing.
- **Implementation complexity:** **Medium to High**
- **Maintenance burden:** **High**
- **Risk level:** **Medium**
- **Deployment priority:** **PRIORITY CANDIDATE FOR RENTAL OPERATIONS**
...
- Confirm current API/integration surface, multilingual/customer-facing UX suitability, and whether Hylono wants Leihs as the rental source of truth or only as the back-office engine.
...
- Contains identifiable booking and equipment assignment data; EU hosting is a positive fit if deployed carefully.
