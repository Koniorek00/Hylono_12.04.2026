...
- Introduce ZITADEL first as the IdP for internal tools and selected admin surfaces, then decide whether the public site should federate through it.
...
- Read official self-host docs, Auth.js provider strategy, and the current Hylono auth architecture before proposing migration or brokering.
...
### Never-assume list
- Never assume identity migration is low-risk. Never assume every app supports the same standards or claims mapping without testing.
