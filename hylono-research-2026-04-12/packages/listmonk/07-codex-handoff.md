...
- Use Listmonk for newsletters/broadcasts only; keep transactional messaging in Novu/Resend.
...
- Read newsletter-signup flows and current Resend usage before implementing.
...
### Never-assume list
- Never merge marketing and transactional preference logic without an explicit model.
