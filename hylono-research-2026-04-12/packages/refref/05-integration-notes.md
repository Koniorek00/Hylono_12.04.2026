# RefRef — Integration Notes

## Phase E — Hylono fit analysis
- **Business usefulness:** Could tie to Hylono referral or ambassador programs later via Next.js, n8n, CRM, and notifications.
- **Implementation complexity:** **Medium**
- **Maintenance burden:** **Medium**
- **Risk level:** **High**
- **Deployment priority:** **LATER / EXPERIMENTAL**
...
- Confirm whether Hylono actually needs a referral platform and whether the project maturity is acceptable.
...
- Participant and referral-contact data require standard privacy controls.
