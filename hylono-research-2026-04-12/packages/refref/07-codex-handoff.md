...
- Treat as experimental unless a real referral program exists and product maturity is validated.
...
- Read project maturity notes before considering implementation.
...
### Never-assume list
- Never assume alpha/open-source referral tooling is production-ready for customer trust-sensitive programs.
