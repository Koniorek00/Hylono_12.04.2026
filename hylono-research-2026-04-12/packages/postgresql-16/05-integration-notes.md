# PostgreSQL 16 — Integration Notes

## Phase E — Hylono fit analysis
- **Business usefulness:** Backbone for the Hylono Next.js app and a strong fit for ZITADEL, Kong, Cal.com, Medusa, Lago, Metabase, Appsmith, and other app databases.
- **Implementation complexity:** **Medium**
- **Maintenance burden:** **Medium**
- **Risk level:** **High**
- **Deployment priority:** **DEPLOY/HARDEN NOW**
...
- Decide whether Hylono will centralize multiple app schemas on shared PostgreSQL clusters or isolate high-risk apps into separate instances.
...
- Will almost certainly hold customer and business data. EU residency, backup geography, encryption, and retention policies matter.
