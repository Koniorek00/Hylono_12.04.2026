# ThingsBoard — Integration Notes

## Phase E — Hylono fit analysis
- **Business usefulness:** Strong only if Hylono products/devices become connected and need dashboards/alerts.
- **Implementation complexity:** **High**
- **Maintenance burden:** **High**
- **Risk level:** **High**
- **Deployment priority:** **LATER / ONLY IF IOT STRATEGY IS REAL**
...
- Confirm whether connected-device telemetry is a near-term roadmap item.
...
- Telemetry and customer-device linkage can become personal data.
