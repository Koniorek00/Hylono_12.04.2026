...
- Defer until device telemetry is real and architectural requirements are clear.
...
- Read the IoT strategy and overlap map before touching ThingsBoard.
...
### Never-assume list
- Never deploy an IoT platform just because device-adjacent business exists.
