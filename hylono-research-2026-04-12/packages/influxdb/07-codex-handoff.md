...
- Avoid until a specific telemetry workload justifies it.
...
- Read the observability and IoT stack notes before considering InfluxDB.
...
### Never-assume list
- Never add a dedicated time-series store without a demonstrated query/scale need.
