# Lago — Integration Notes

## Phase E — Hylono fit analysis
- **Business usefulness:** Could connect to Stripe, Next.js checkout/rental APIs, n8n automation, Twenty CRM account data, Novu notifications, and Metabase finance reporting.
...
- Define whether Hylono actually needs usage/subscription billing beyond current Stripe capabilities. Decide whether Lago or Invoice Ninja should own invoice generation if both are present.
...
- Contains customer billing data; treat as financial system of record if adopted.
