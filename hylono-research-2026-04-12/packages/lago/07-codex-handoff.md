...
- Use Lago only when subscription/usage billing is a confirmed requirement; isolate it as a dedicated billing service, not a casual add-on.
...
- Read current Hylono pricing, rental, and checkout flows before proposing Lago implementation.
...
### Never-assume list
- Never assume finance will accept a new billing source of truth without reconciliation, tax, and invoice workflow validation.
