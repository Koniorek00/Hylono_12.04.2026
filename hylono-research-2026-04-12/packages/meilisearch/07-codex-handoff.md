...
- Add Meilisearch when there is a clear search surface worth indexing.
...
- Read actual search requirements and content architecture before implementing.
...
### Never-assume list
- Never index sensitive datasets into a public-facing search service.
