...
- Use BookStack as the internal protocol and runbook wiki, behind SSO when available.
...
- Read internal docs requirements and the overlap map with Outline/Docusaurus.
...
### Never-assume list
- Never conflate internal SOP docs with public product/docs site needs.
