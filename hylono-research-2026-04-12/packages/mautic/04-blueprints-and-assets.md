# Mautic — Blueprints and Assets

    ## Phase D — Indexed deployment and implementation assets
    | Asset | Kind | Status | License / usage | Version | Notes |
|---|---|---|---|---|---|
| Official docs | official docs | indexed-only | GPL-3.0 | 7.0.1 | Primary docs. |
| Official repo | source code | indexed-only | GPL-3.0 | 7.0.1 | Code source. |
| Docker docs | install docs | indexed-only | docs | 7.0.1 | Install guidance. |
