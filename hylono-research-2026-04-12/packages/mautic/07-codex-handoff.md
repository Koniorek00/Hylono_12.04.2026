...
- Use only when a real nurture-marketing program requires it.
...
- Read the overlap map with Listmonk/Novu before planning Mautic.
...
### Never-assume list
- Never adopt a marketing automation suite before the team/process is ready to operate it.
