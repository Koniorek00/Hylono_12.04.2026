...
- Roll out Prometheus with a small curated target set and pair it with Grafana.
...
- Read the service inventory and identify exporters/metrics endpoints first.
...
### Never-assume list
- Never scrape everything indiscriminately or allow high-cardinality labels to explode costs.
