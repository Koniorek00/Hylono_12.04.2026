...
- Do not implement until an explicit lifecycle-marketing gap remains after Novu/Listmonk/Mautic decisions.
...
- Verify the intended product identity and overlap map before doing anything else.
...
### Never-assume list
- Never assume 'Ditto' means Dittofeed. Never assume another customer-messaging platform is needed just because it exists in the long list.
